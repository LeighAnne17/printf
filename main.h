...
int print_string(va_list types, char buffers[], int flags, int width, int precision, int size);
int print_percent(va_list types, char buffers[], int flags, int width, int precision, int size);
...
int print_hexa(va_list types, char buffer[], char map_to[], int flags, char flag_ch, int width, int precision, int size);
...
/* prints non printable character */
